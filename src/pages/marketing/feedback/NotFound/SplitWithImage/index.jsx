...
const SplitWithImage = () => {
  return (
    <ComponentContainer title={"Split with image"}>
      <>
        {/*
          ...
          ```
        */}
        <div className="grid min-h-full grid-cols-1 grid-rows-[1fr,auto,1fr] bg-white lg:grid-cols-[max(50%,36rem),1fr] rounded-xl border border-slate-200">
