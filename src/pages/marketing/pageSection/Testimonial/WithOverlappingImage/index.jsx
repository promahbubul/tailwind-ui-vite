...
const WithOverlappingImage = () => {
  return (
    <ComponentContainer title={"With overlapping image"}>
      <div className="bg-white pb-16 pt-24 sm:pb-24 sm:pt-32 xl:pb-32 rounded-xl border border-slate-200">
...
export default WithOverlappingImage;
