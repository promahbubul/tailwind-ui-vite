...
const WithLargeAvatar = () => {
  return (
    <ComponentContainer title={"With large avatar"}>
      <section className="isolate overflow-hidden bg-white px-6 lg:px-8 rounded-xl border border-slate-200">
...
export default WithLargeAvatar;
