...
const WithStarRating = () => {
  return (
    <ComponentContainer title={"With star rating"}>
      <section className="bg-white px-6 py-24 sm:py-32 lg:px-8 rounded-xl border border-slate-200">
