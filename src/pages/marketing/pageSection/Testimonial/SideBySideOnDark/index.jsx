...
const SideBySideOnDark = () => {
  return (
    <ComponentContainer title={"Side-by-side on dark"}>
      <section className="bg-gray-900 py-24 sm:py-32 rounded-xl border border-slate-200">
...
export default SideBySideOnDark;
