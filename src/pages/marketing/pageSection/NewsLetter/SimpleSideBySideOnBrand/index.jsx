...
const SimpleSideBySideOnBrand = () => {
  return (
    <ComponentContainer title={"Simple side-by-side on brand"}>
      <div className="bg-indigo-700 py-16 sm:py-24 lg:py-32 rounded-xl border border-slate-200">
