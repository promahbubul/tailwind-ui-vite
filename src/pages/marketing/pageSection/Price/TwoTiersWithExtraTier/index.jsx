...
const TwoTiersWithExtraTier = () => {
  return (
    <ComponentContainer title={"Two tiers with extra tier"}>
      <div className="isolate overflow-hidden bg-gray-900 rounded-lg border border-gray-200">
