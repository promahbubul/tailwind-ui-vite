...
const WithBackgroundImage = () => {
  return (
    <ComponentContainer title={"With background image"}>
      <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32 rounded-xl border border-slate-200">
        <img
