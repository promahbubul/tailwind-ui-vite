...
const WithTwoColumnDescriptionOnDark = () => {
  return (
    <ComponentContainer title={"With two column description on dark"}>
      <div className="bg-gray-900 py-24 sm:py-32 rounded-xl border border-slate-200">
