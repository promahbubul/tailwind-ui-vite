...
const StackedWithFooterList = () => {
  return (
    <ComponentContainer title={"Stacked with footer list"}>
      <Popover className="relative  rounded-xl ">
        <Popover.Button className="inline-flex absolute items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900">
          <span>Resources</span>
