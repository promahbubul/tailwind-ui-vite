...
const LeftAlignedWithInlineActions = () => {
  return (
    <ComponentContainer title={"Left-aligned with inline actions"}>
      <div className="rounded-xl border border-slate-200 py-10 px-40">
...
export default LeftAlignedWithInlineActions;
