...
const NarrowWithSmallAvatarsOnDark = () => {
  return (
    <ComponentContainer title={"Narrow with small avatars on dark"}>
      <ul role="list" className="divide-y divide-white/5 border border-slate-200 p-10 rounded-md">
