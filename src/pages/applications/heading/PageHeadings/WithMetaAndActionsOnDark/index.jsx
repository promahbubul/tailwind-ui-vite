...
const WithMetaAndActionsOnDark = () => {
  return (
    <ComponentContainer title={"With meta and actions on dark"}>
      <div className="lg:flex lg:items-center lg:justify-between rounded-xl border border-slate-200 p-10 bg-slate-800 ">
