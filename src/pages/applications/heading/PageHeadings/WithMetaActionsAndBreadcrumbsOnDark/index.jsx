...
const WithMetaActionsAndBreadcrumbsOnDark = () => {
  return (
    <ComponentContainer title={"With meta, actions, and breadcrumbs on dark"}>
      <div className="rounded-xl border border-slate-200 p-10 h-96 bg-slate-800 ">
