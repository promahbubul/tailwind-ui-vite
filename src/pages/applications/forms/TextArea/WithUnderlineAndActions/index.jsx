...
const WithUnderlineAndActions = () => {
  const [selected, setSelected] = useState(moods[5]);
  return (
    <ComponentContainer title={"With underline and actions"}>
      <div className="flex items-start space-x-4 border p-10 border-gray-300 rounded-md">
