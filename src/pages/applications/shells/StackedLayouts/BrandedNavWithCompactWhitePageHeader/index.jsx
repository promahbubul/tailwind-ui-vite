...
const BrandedNavWithCompactWhitePageHeader = () => {
  return (
    <ComponentContainer title={"Branded nav with compact white page header"}>
      <>
        {/*
        ...
        ```
      */}
        <div className="min-h-full rounded-xl border border-slate-200">
...
export default BrandedNavWithCompactWhitePageHeader;
