...
const ConstrainedWithStickyColumns = () => {
  return (
    <ComponentContainer title={"Constrained with sticky columns"}>
      <div className="flex min-h-full flex-col rounded-xl border border-slate-200">
